...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{as}\NormalTok{(order_rules, }\DataTypeTok{Class =} \StringTok{"data.frame"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{reorder}\NormalTok{(rules, confidence), }\DataTypeTok{y =}\NormalTok{ confidence)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_col}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{coord_flip}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Reglas derivadas"}\NormalTok{, }\DataTypeTok{x =} \StringTok{"reglas"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{patrones_freq_files/figure-latex/unnamed-chunk-6-1.pdf}
